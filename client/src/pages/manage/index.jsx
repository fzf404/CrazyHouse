...
import { AtToast, AtList, AtButton, AtListItem, AtModal, AtModalHeader, AtModalContent, AtModalAction, AtMessage } from 'taro-ui'
          ...
          <View className='at-row'>
            <View className='at-col'>
              <AtButton
                ...
                onClick={() => {
                  this.setState({
                    orderListChoice: !this.state.orderListChoice
                  })
                  let orderList = this.state.orderList
                  // 对orderList进行重排序
                  if (this.state.orderListChoice) {
